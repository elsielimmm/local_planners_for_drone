...
def generate_launch_description():
    ...
    odom_visualization_node = Node(
        ...
        output='screen',
        remappings=[
            ('odom', '/model/x500_mono_cam_0/odom'),  # Use GZ sim odom directly
    ...
    pcl_render_node = Node(
        ...
        remappings=[
            ...
            ('local_map', '/depth_camera/points'),  # GZ sim depth camera points
            ('odometry', '/model/x500_mono_cam_0/odom'),  # GZ sim odometry (bridged)
