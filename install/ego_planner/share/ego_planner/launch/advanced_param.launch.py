...
def generate_launch_description():
    ...
    map_size_x = LaunchConfiguration('map_size_x_', default=50.0)
    map_size_y = LaunchConfiguration('map_size_y_', default=50.0)
    map_size_z = LaunchConfiguration('map_size_z_', default=10.0)
    ...
    ego_planner_node = Node(
        ...
        output='screen',
        remappings=[
            ('odom_world', '/model/x500_mono_cam_0/odom'),  # Direct from GZ bridge
            ...
            ('grid_map/odom', '/model/x500_mono_cam_0/odom'),  # Direct from GZ bridge
            ('grid_map/cloud', '/depth_camera/points'),  # Use raw PCL from GZ sim camera
        ...
        parameters=[
            ...
            {'grid_map/fx': fx},
            {'grid_map/fy': fy},
            # camera extrinsic (cam2body transformation)
            {'grid_map/cam_extrinsic': [1.0, 0.0, 0.0, 0.12,
                                        0.0, 1.0, 0.0, 0.03,
                                        0.0, 0.0, 1.0, 0.242,
                                        0.0, 0.0, 0.0, 1.0]},
            # depth filter
